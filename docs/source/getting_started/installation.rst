...
4. Clone the `hpmpy-template` into your new local repo folder:
   ...
   .. code-block:: console
      ...
      $ git clone https://github.com/tZ3ma/fogd-db my-project
...
8. Rename all hpmpy instances after your project using git grep by replacing
   ...
   .. code-block:: console
      ...
      $ git grep -lz fogd-db | xargs -0 sed -i -e "s/fogd-db/MY-PROJECT/g"
      $ git grep -lz fogd_db | xargs -0 sed -i -e "s/fogd_db/MY_PROJECT/g"

9. Rename the :file:`src/fogd_db` package folder by replacing
   :code:`MY_PROJECT` below:

      .. code-block:: console

         $ mv src/fogd_db src/MY_PROJECT
...
3. Clone the repo to a local directory (uses package name if square bracket
   ...
   .. code-block:: console
      ...
      $ git clone https://github.com/tZ3ma/fogd-db [fogd-db-develop]
...
.. code-block:: console
   ...
   $ pip install --index-url https://test.pypi.org/simple/ --extra-index-url https://pypi.org/simple/ fogd-db
